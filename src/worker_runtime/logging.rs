...
macro_rules! log_auth {
    ($($arg:tt)*) => {
        log::info!(target: $crate::worker_runtime::logging::targets::AUTH, $($arg)*)
    };
}
...
macro_rules! log_api {
    ($($arg:tt)*) => {
        log::debug!(target: $crate::worker_runtime::logging::targets::API, $($arg)*)
    };
}
...
macro_rules! log_db {
    ($($arg:tt)*) => {
        log::debug!(target: $crate::worker_runtime::logging::targets::DB, $($arg)*)
    };
}
...
macro_rules! log_external {
    ($($arg:tt)*) => {
        log::info!(target: $crate::worker_runtime::logging::targets::EXTERNAL, $($arg)*)
    };
}
